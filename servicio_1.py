...
def servicio_1(num1, num2):
    try:
        ...
        result = num1 // num2
        logger.info(f'Resultado de la división entera: {result}')
    except ValueError:
        logger.error('Error: Por favor ingrese números válidos.')
    except ZeroDivisionError:
        logger.error('Error: No se puede dividir por cero.')
